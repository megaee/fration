...
# C:\Zeus\Correct\Wizard_mode\input_103
path="C:\Zeus\Correct\Wizard_mode\input_104"
...
def create_new(new_state,pro):
    ...
    f = open("C:\\Zeus\\Correct\\Wizard_mode\\input_104\\"+no+".py",'w')
...
########################################################################
    ...
    for pll in ['A','B','C','D','FT']:
        ...
        #     new_state[ "pages"][ "PLL"][pll]['value']['free_running']['value']['phase_lock_loss']['value']['phase_delta']['value']='75 ns'
        print(new_state[ "pages"][ "PLL"][pll]['value']['free_running']['value']['phase_lock_loss']['value']['phase_delta']['value'])
